...
$(function() {
        ...
        if ($(".requiredField").each(function() {
            ...
            $.post($(this).attr("action"), r, function() {
                $("form#form").slideUp("fast", function() {
                    $(this).before('<div class="success"></div>');
                });
            });
        }
        return !1;
    ...
    $("form#subscribe").on("submit", function() {
        ...
        if ($(".subscribe-requiredField").each(function() {
                if ("" === jQuery.trim($(this).val())) $(this).prev("label").text(), $(this).parent().append('<span class="subscribe-error"></span>'),
                    $(this).addClass("inputError"), s = !0;
                else if ($(this).hasClass("subscribe-email")) {
                    var r = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
                    r.test(jQuery.trim($(this).val())) || ($(this).prev("label").text(), $(this).parent().append('<span class="subscribe-error"></span>'),
                        $(this).addClass("inputError"), s = !0);
                }
            }), !s) {
            ...
            $.post($(this).attr("action"), r, function() {
                $("form#subscribe").slideUp("fast", function() {
                    $(this).before('<div class="subscribe-success"></div>');
                });
            });
        }
        return !1;
    ...
    // 9. countdown date
    var end = new Date("02/28/2021 12:00 PM"); // FORMAT: month/day/year time
    var _second = 1000;
    ...
    function showRemaining() {
        ...
        if (distance < 0) {
            clearInterval(timer);
            document.getElementById("countdown").innerHTML = "EMPIEZA EL ESTRENO";
            return;
        }
        ...
        document.getElementById("countdown").innerHTML += seconds + "s aprox.estreno";
    }
    ...
    $("#background-video").YTPlayer({
        videoId: "NmJGFHojtZE", // DEMO URL is: https://www.youtube.com/watch?v=3zXrWmkVjTM
