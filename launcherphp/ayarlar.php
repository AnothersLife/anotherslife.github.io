...
$db_name = "atl_framework"; // mysql veritabani adi
...
$fivem_server  = ""; // fivem server url örn; cfx.re/join/o6yo6y
$discord       = ""; // discord sunucu adresiniz (bos birakilirsa launcherda discord butonu gizlenir)
